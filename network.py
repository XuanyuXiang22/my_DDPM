...
class Block(nn.Module):
    ...
    def __init__(self, dim, dim_out, groups=8):
        ...
        self.proj = nn.Conv2d(dim, dim_out, kernel_size=3, stride=1, padding=1)
...
class PreNorm(nn.Module):
    """there's been a debate about whether to apply normalization
...
class Unet(nn.Module):
    def __init__(self,
        ...
        block_klass = partial(ResnetBlock, groups=resnet_block_groups)  # 目前没有实现 convNeXt
